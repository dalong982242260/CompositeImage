...
public class ImageSynthesisLayout2 extends FrameLayout {
    ...
    public ImageSynthesisLayout2(@NonNull Context context) {
        this(context, null);
    }

    public ImageSynthesisLayout2(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ImageSynthesisLayout2(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
